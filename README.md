...
We also noted that there are issues of numerical instablility for the current version due to the non-uniqueniss of SVD. Any suggestions regarding this are welcome. 
